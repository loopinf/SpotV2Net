...
def generate_matrices(source='price'):
    ...
    # elif source == 'vol':
    #     filenames = ['covol_of_vol', 'vol_of_vol']
    #     # filenames = ['covol_of_vol202306_09', 'vol_of_vol202306_09']
    ...
    #     #     df = df.shift(-1)
    #     #     df.iloc[-1] = last_row.iloc[-1]
    #     #     # df = df.iloc[1:].append(pd.Series(last_row.iloc[-1])) # FIXed MISTAKE - probably new version of pandas
