...
opts = detectImportOptions('rawdata/dji_1min_rthjdp/AAPL_1min.txt','Delimiter',{',' }); 
opts.SelectedVariableNames = {'Var1','Var2','Var3','Var4','Var5','Var6'  };
price = readtable('rawdata/dji_1min_rthjdp/AAPL_1min.txt',opts);
toc
...
clear D Mo Ye  
 ...
 Pnum=table2array(price(:,5)); % prendere qua le date
